  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Swag, where secure access is just a key away. Connect to your accounts swiftly and securely, because your security is our priority."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1575908539614-ff89490f4a78?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxrZXlzfGVufDB8fHx8MTY5NTMxNTE0OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@hocza?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Jozsef Hocza`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Swag, where secure access is just a key away. Connect to your accounts swiftly and securely, because your security is our priority.`}
            </Text>
            <Box
