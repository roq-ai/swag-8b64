...
import { getKeyById } from 'apiSdk/keys';
import { KeyInterface } from 'interfaces/key';

function KeyViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('key', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/keys/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Key Value" text={data?.key_value} />
